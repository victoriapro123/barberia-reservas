...
- Si no configuras las variables de entorno en Vercel, la solicitud se guardara pero el correo fallara.
...
5. Configura las variables de entorno de Vercel antes de depender del correo en produccion.
